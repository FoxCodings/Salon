...
<div class="card-footer">
  ...
  <a href="/nomina2" class="btn btn-default">Regresar</a>
...
function buscar(){
  ...
  if (fecha_inicio == '' || fecha_fin == '') {
    ...
    $.ajax({
       ...
       type:"POST",
       url:"/nomina2/TrerComisionesExtras",
       headers: {
    ...
    $.ajax({
           ...
           url:"/nomina2/BuscarPagos", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
           headers: {
...
function guardar(){
  ...
  $.ajax({
         ...
         url:"/nomina2/crearHistorial", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
         headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')//esto siempre debe ir en los ajax
         },
          data: {
