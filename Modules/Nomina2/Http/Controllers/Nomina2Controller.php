...
use \Modules\Nomina2\Entities\Historial;
use \Modules\Nomina2\Entities\Semana;
...
class Nomina2Controller extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function show($id)
    {
        ...
        return view('nomina2::show')->with($data);
    }
    ...
    public function historial($id)
    {
        $data['empleados'] = Empleados::find($id);
        //$data['servicios'] = ServicioVentas::where([['activo',1],['id_cliente',$id]])->get();
        return view('nomina2::historial')->with($data);
    }
    ...
    public function BuscarPagos(Request $request){
      ...
      if ($request->semana == 1) {
        $bienes_query = ("
          ...
          WHERE  t_cat_ventas.id_empleado = $request->id AND empleados.activo = 1 and empleados.modulo = 2 AND t_cat_ventas.created_at BETWEEN '".$fecha_inicio."' AND '".$fecha_fin."'
         ");
      ...
      if ($request->semana == 1) {
        $bienes_query = ("
          ...
          t_cat_ventas.created_at
           FROM empleados
          INNER JOIN t_cat_ventas ON t_cat_ventas.id_empleado_servicio = empleados.id
          WHERE  t_cat_ventas.id_empleado_servicio = $request->id AND empleados.activo = 1 and empleados.modulo = 2 AND t_cat_ventas.created_at BETWEEN '".$fecha_inicio."' AND '".$fecha_fin."'
         ");
         $bienes= DB::select($bienes_query);
    ...
    public function pagos($id)
    {
        ...
        return view('nomina2::pagos')->with($data);
    }
    ...
    public function tablanomina2(){
      ...
      $registros = Empleados::where([['activo', 1],['modulo',2],['id','!=',1]])->get();
      ...
      foreach ($data->data as $key => $value) {
            ...
            $acciones = [
              "Pago" => [
                "icon" => "edit blue",
                "href" => "/nomina2/$value->id/show"
              ],
              "Historial" => [
                "icon" => "edit blue",
                "href" => "/nomina2/$value->id/historial"
              ],
            ];
