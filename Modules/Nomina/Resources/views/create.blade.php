...
<h3 class="card-title">
 ...
 @isset($nominas) Editar @else Nuevo @endisset   Nomina
</h3>
...
<div class="card-body">
        <div class="row">
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="nombre" value="@isset($nominas) {{ $nominas->nombre }} @endisset" placeholder="Nombre" required>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="apellido_paterno" value="@isset($nominas) {{ $nominas->apellido_paterno }} @endisset" placeholder="Apellido Paterno" required>
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="apellido_materno" value="@isset($nominas) {{ $nominas->apellido_materno }} @endisset" placeholder="Apellido Materno" required>
              <div class="invalid-feedback">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="direccion" value="@isset($nominas) {{ $nominas->direccion }} @endisset" placeholder="Dirección" required>
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="telefono" value="@isset($nominas) {{ $nominas->telefono }} @endisset" placeholder="Telefono" required>
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input  type="text" id="sueldo"  class="form-control " autocomplete="off" value="@isset($nominas) {{ $nominas->sueldo }} @endisset"  placeholder="Sueldo" required>
              <div class="invalid-feedback">
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($nominas) ) ? '/nomina/update': '/nomina/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
