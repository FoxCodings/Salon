...
use \Modules\Promociones2\Entities\Clientes_Promocion;
...
class Promociones2Controller extends Controller
{
  public function __construct()
  {
    ...
    public function index()
    {
        ...
        return view('promociones2::index');
    }
    ...
    public function create()
    {
        ...
        return view('promociones2::create')->with($data);
    }
    ...
    public function createcumpleanos()
    {
      ...
      $fecho = date("Y-m-t", strtotime($date));
        ...
        $data['clientes'] = Cliente_Cumpleano::where([['activo',1],['modulo',2]])->get();
        $data['descuentos'] = Descuentos::where('activo',1)->get();
        //dd($data);
        return view('promociones2::createcumpleanos')->with($data);
    }
    ...
    public function tablapromociones2(){
      setlocale(LC_TIME, 'es_ES');
      \DB::statement("SET lc_time_names = 'es_ES'");
      $registros = Promociones::where([['activo', 1],['modulo',2]])->get(); //user es una entidad que se trae desde la app
