...
<div class="card-toolbar">
  ...
  <div class="dropdown dropleft">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="/promociones2/create">Promoción</a>
        <a class="dropdown-item" href="/promociones2/createcumpleanos">Promoción Cumpleaños</a>
    </div>
</div>
...
<script type="text/javascript">
    ...
    tabla = $('#kt_datatable').DataTable({
      ...
      order: [[0, 'desc']],
      ajax: {
        url: "/promociones2/tablapromociones2",
      },
      columns: [
