...
<div class="card-footer">
  ...
  <a href="/proveedores" class="btn btn-default">Regresar</a>
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($proveedores) ) ? '/proveedores/update': '/proveedores/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
