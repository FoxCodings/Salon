...
class ProveedoresController extends Controller
{
    ...
    public function edit($id)
    {
      ...
      return view('proveedores::create')->with($data);
    }
    ...
    public function tablaproveedores(){
      ...
      $registros = Proveedores::where([['activo', 1],['modulo',1]])->get(); //user es una entidad que se trae desde la app
      ...
      foreach ($data->data as $key => $value) { //el array acciones se constuye en el helpers dropdown - helpers esta con bootsrap
        ...
        //   }else{
            $acciones = [
              "Editar" => [
                "icon" => "edit blue",
                "href" => "/proveedores/$value->id/edit" //esta ruta esta en el archivo web
              ],
              "Eliminar" => [
                "icon" => "edit blue",
                "onclick" => "eliminar($value->id)"
