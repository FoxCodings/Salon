...
use \Modules\Catalogos2\Entities\Tipo_Servicio;
use \Modules\Catalogos2\Entities\Sesiones;
...
class ServiciosController extends Controller
{
    ...
    {
        return view('catalogos2::servicios.index');
    }
    ...
    public function create()
    {
        $data['tipo_servicio'] = Tipo_Servicio::where('activo',1)->get();
         ...
         //dd($data);
         return view('catalogos2::servicios.create')->with($data);
    }
    ...
    {
        return view('catalogos2::servicios.show');
    }
    ...
    public function tablaservicios(){
      ...
      $registros = Servicios::where([['activo', 1],['modulo',2]])->get();
      ...
      foreach ($data->data as $key => $value) {
        ...
        //   }else{
            $acciones = [
              "Editar" => [
                "icon" => "edit blue",
                "href" => "/catalogos2/servicios/$value->id/edit"
              ],
              "Eliminar" => [
                "icon" => "edit blue",
                "onclick" => "eliminar($value->id)"
