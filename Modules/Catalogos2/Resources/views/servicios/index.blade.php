...
<a href="/catalogos2/servicios/create" class="btn btn-primary font-weight-bolder">
...
<script type="text/javascript">
    ...
    tabla = $('#kt_datatable').DataTable({
      ...
      order: [[0, 'desc']],
      ajax: {
        url: "/catalogos2/servicios/tablaservicios",
      },
      columns: [
        { data: 'nombre', name : 'nombre'},
        { data: 'servicio_para', name : 'servicio_para'},
    ...
    Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
               ...
               url:"/catalogos2/servicios/borrar",
               headers: {
