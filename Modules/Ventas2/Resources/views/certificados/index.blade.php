...
<a href="/ventas2/certificados/create" class="btn btn-primary font-weight-bolder">
...
<script type="text/javascript">
    ...
    tabla = $('#kt_datatable').DataTable({
      ...
      order: [[0, 'desc']],
      ajax: {
        url: "/ventas2/certificados/tablacertificados",
      },
      columns: [
    ...
    Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
               ...
               url:"/ventas2/certificados/borrar",
               headers: {
