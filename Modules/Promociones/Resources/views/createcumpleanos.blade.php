...
<div class="col-md-12">
	<div class="card card-primary">
	    <div class="card-header with-border">
			...
			@else
			<h3 class="card-title">Nueva Promoción de Cumpleaños</h3>
			@endisset
	    </div>
	    <!-- /.box-header -->
	    <!-- form start -->
	    <form role="form">
	      ...
	      <div class="card-footer">
	      	<a href="{{ url('promociones') }}" class="btn btn-secondary">Regresar</a>
	...
	$(document).ready( function () {
        ...
        if( descuentos_promocion == '' || clientes_promocion == '' || fecha_vigencia == ''){
        	...
        	$.ajax({
	           ...
	           url:"{{ ( isset($promocion) ) ? '/promociones/' . $promocion->id : '/promociones/creates' }}",
	           headers: {
