...
<div class="card-footer">
  ...
  <a href="/ventas/certificados" class="btn btn-default">Regresar</a>
  ...
  //console.log('entro')
    ...
    if (nombre_cliente == '' ||
      ...
      $.ajax({
             ...
             url:"{{ ( isset($certificados) ) ? '/ventas/certificados/update': '/ventas/certificados/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
             headers: {
