...
<h3 class="card-title">
 ...
 @isset($alaciados) Editar @else Nuevo @endisset   Tratamiento
</h3>
...
<div class="card-body">
        <div class="row">
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="nombre" value="@isset($alaciados) {{ $alaciados->nombre }} @endisset" placeholder="Nombre" required>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="costo" value="@isset($alaciados) {{ $alaciados->costo }} @endisset" placeholder="Costo" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="comision" value="@isset($alaciados) {{ $alaciados->comision }} @endisset" placeholder="Comisión" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
...
<div class="card-footer">
  ...
  <a href="/catalogos/alaciados" class="btn btn-default">Regresar</a>
...
function guardar(){
  ...
  //console.log('entro')
    @isset($alaciados)
    var id = {{$alaciados->id}};
    formData.append('id',{{ $alaciados->id }});
    @else
    var id = 0;
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($alaciados) ) ? '/catalogos/alaciados/update': '/catalogos/alaciados/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
                        ...
                        Swal.fire({
                          ...
                          timer: 1500,
                            ...
                            if (result.value == true) {
                              ...
                              location.href ="/catalogos/alaciados";
                              $('.botoncito').show();
                            }
                        })
