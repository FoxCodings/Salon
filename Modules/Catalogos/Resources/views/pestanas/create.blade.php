...
<h3 class="card-title">
 ...
 @isset($pestanas) Editar @else Nuevo @endisset  Pestaña y Ceja
</h3>
...
<div class="card-body">
        <div class="row">
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="nombre" value="@isset($pestanas) {{ $pestanas->nombre }} @endisset" placeholder="Nombre" required>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="costo" value="@isset($pestanas) {{ $pestanas->costo }} @endisset" placeholder="Costo" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="comision" value="@isset($pestanas) {{ $pestanas->comision }} @endisset" placeholder="Comisión" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
...
<div class="card-footer">
  ...
  <a href="/catalogos/pestanas" class="btn btn-default">Regresar</a>
...
function guardar(){
  ...
  //console.log('entro')
    @isset($pestanas)
    var id = {{$pestanas->id}};
    formData.append('id',{{ $pestanas->id }});
    @else
    var id = 0;
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($pestanas) ) ? '/catalogos/pestanas/update': '/catalogos/pestanas/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
                        ...
                        Swal.fire({
                          ...
                          timer: 1500,
                            ...
                            if (result.value == true) {
                              ...
                              location.href ="/catalogos/pestanas";
                              $('.botoncito').show();
                            }
                        })
