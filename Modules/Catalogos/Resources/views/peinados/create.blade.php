...
<h3 class="card-title">
 ...
 @isset($peinados) Editar @else Nuevo @endisset  Peinado
</h3>
...
<div class="card-body">
        <div class="row">
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="nombre" value="@isset($peinados) {{ $peinados->nombre }} @endisset" placeholder="Nombre" required>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="costo" value="@isset($peinados) {{ $peinados->costo }} @endisset" placeholder="Costo" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="comision" value="@isset($peinados) {{ $peinados->comision }} @endisset" placeholder="Comisión" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
...
<div class="card-footer">
  ...
  <a href="/catalogos/peinados" class="btn btn-default">Regresar</a>
...
function guardar(){
  ...
  //console.log('entro')
    @isset($peinados)
    var id = {{$peinados->id}};
    formData.append('id',{{ $peinados->id }});
    @else
    var id = 0;
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($peinados) ) ? '/catalogos/peinados/update': '/catalogos/peinados/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
                        ...
                        Swal.fire({
                          ...
                          timer: 1500,
                            ...
                            if (result.value == true) {
                              ...
                              location.href ="/catalogos/peinados";
                              $('.botoncito').show();
                            }
                        })
