...
<h3 class="card-title">
 ...
 @isset($fasts) Editar @else Nuevo @endisset   Fast Nail
</h3>
...
<div class="card-body">
        <div class="row">
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="nombre" value="@isset($fasts) {{ $fasts->nombre }} @endisset" placeholder="Nombre" required>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="costo" value="@isset($fasts) {{ $fasts->costo }} @endisset" placeholder="Costo" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="comision" value="@isset($fasts) {{ $fasts->comision }} @endisset" placeholder="Comisión" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
...
<div class="card-footer">
  ...
  <a href="/catalogos/fasts" class="btn btn-default">Regresar</a>
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($fasts) ) ? '/catalogos/fasts/update': '/catalogos/fasts/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
