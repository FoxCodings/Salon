...
<h3 class="card-title">
 ...
 @isset($shellacs) Editar @else Nuevo @endisset  Shellac
</h3>
...
<div class="card-body">
        <div class="row">
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="nombre" value="@isset($shellacs) {{ $shellacs->nombre }} @endisset" placeholder="Nombre" required>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="costo" value="@isset($shellacs) {{ $shellacs->costo }} @endisset" placeholder="Costo" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="comision" value="@isset($shellacs) {{ $shellacs->comision }} @endisset" placeholder="Comisión" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
...
<div class="card-footer">
  ...
  <a href="/catalogos/shellacs" class="btn btn-default">Regresar</a>
...
function guardar(){
  ...
  //console.log('entro')
    @isset($shellacs)
    var id = {{$shellacs->id}};
    formData.append('id',{{ $shellacs->id }});
    @else
    var id = 0;
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($shellacs) ) ? '/catalogos/shellacs/update': '/catalogos/shellacs/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
                        ...
                        Swal.fire({
                          ...
                          timer: 1500,
                            ...
                            if (result.value == true) {
                              ...
                              location.href ="/catalogos/shellacs";
                              $('.botoncito').show();
                            }
                        })
