...
<div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="comision"  value="@isset($productos) {{ $productos->comision }} @endisset" placeholder="Comisión" required >
              <div class="invalid-feedback">
        ...
        <div class="row">
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="codigo"  value="@isset($productos) {{ $productos->codigo }} @endisset" placeholder="Codigo de Barras" required >
              <div class="invalid-feedback">
...
<div class="card-footer">
  ...
  <a href="/catalogos/productos" class="btn btn-default">Regresar</a>
...
codigo == '') {
      ...
      $.ajax({
             ...
             url:"{{ ( isset($productos) ) ? '/catalogos/productos/update': '/catalogos/productos/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
             headers: {
                  ...
                  Swal.fire({
                    ...
                    timer: 1500,
                      ...
                      if (result.value == true) {
                        ...
                        location.href ="/catalogos/productos";
                        $('.botoncito').show();
                      }
                  })
