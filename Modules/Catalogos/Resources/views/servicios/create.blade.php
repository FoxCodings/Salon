...
<div class="card-body">
        <div class="row">
          ...
          <div class="col-md-3 ">
              <div class="form-group">
                <label for="exampleInputPassword1">Serivicio para</label>
                  <select class="form-control" name="servicio_paratipo" onchange="servicioparas()">
                    @isset($servicios)
                      <option value="{{$servicios->tipe}}">
                        <?php
                          if ($servicios->tipe == 1) {
                            echo 'Uñas';
                          }elseif($servicios->tipe == 2){
                            echo 'Cabello';
                          }
          ...
          <div class="col-md-3" id="salon_comision3">
              <label for="inputPassword4"  style="font-size:12px;"class="form-label">Costo: </label>
              <input type="text" class="form-control" id="costo" onchange="porcentaje()" value="@isset($servicios) {{ $servicios->costo }} @endisset" placeholder="Costo" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
          ...
          <div class="col-md-3 " id="salon_comision2">
              <div class="form-group">
                <label for="exampleInputPassword1">Porcentaje</label>
                  <select class="form-control" name="porcentajes" onchange="porcentajes2()">
                    @isset($servicios)
                      <option value="{{$servicios->porcentaje}}">
                        <?php
                          ...
                          }elseif($servicios->porcentaje == 50){
                            echo '50% - Servicio';
                          }elseif($servicios->porcentaje == 30){
                            echo '30% - Servicio';
                          }elseif($servicios->porcentaje == 60){
                            echo '60% - Servicio';
                          }
                         ?>
                      </option>
                    ...
                    <option value="50">50% - Servicio</option>
                    <option value="30">30% - Servicio</option>
                    <option value="60">60% - Servicio</option>
                  </select>
              </div>
          </div>
...
<div class="card-footer">
  ...
  <a href="/catalogos/servicios" class="btn btn-default">Regresar</a>
...
function guardar(){
  ...
  //console.log('entro')
    ...
    var servicio_para = 1;
    var servicio_paratipo = $('select[name=servicio_paratipo]').val();
    ...
    formData.append('servicio_paratipo', servicio_paratipo);
...
porcentajes == '') {
  ...
  $.ajax({
         ...
         url:"{{ ( isset($servicios) ) ? '/catalogos/servicios/update': '/catalogos/servicios/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
         headers: {
              ...
              Swal.fire({
                ...
                timer: 1500,
                  ...
                  if (result.value == true) {
                    ...
                    location.href ="/catalogos/servicios";
                    $('.botoncito').show();
                  }
              })
