...
<a href="/catalogos/servicios_a/create" class="btn btn-primary font-weight-bolder">
...
<script type="text/javascript">
    ...
    tabla = $('#kt_datatable').DataTable({
      ...
      order: [[0, 'desc']],
      ajax: {
        url: "/catalogos/servicios_a/tablaservicios_a",
      },
      columns: [
    ...
    Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
               ...
               url:"/catalogos/servicios_a/borrar",
               headers: {
