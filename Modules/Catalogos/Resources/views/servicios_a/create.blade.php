...
<h3 class="card-title">
 ...
 @isset($servicios_a) Editar @else Nuevo @endisset  Servicio Adicionale
</h3>
...
<div class="card-body">
        <div class="row">
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="nombre" value="@isset($servicios_a) {{ $servicios_a->nombre }} @endisset" placeholder="Nombre" required>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="costo" value="@isset($servicios_a) {{ $servicios_a->costo }} @endisset" placeholder="Costo" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="comision" value="@isset($servicios_a) {{ $servicios_a->comision }} @endisset" placeholder="Comisión" required onkeypress="return NumCheck(event, this)">
              <div class="invalid-feedback">
...
<div class="card-footer">
  ...
  <a href="/catalogos/servicios_a" class="btn btn-default">Regresar</a>
...
function guardar(){
  ...
  //console.log('entro')
    @isset($servicios_a)
    var id = {{$servicios_a->id}};
    formData.append('id',{{ $servicios_a->id }});
    @else
    var id = 0;
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($servicios_a) ) ? '/catalogos/servicios_a/update': '/catalogos/servicios_a/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
                        ...
                        Swal.fire({
                          ...
                          timer: 1500,
                            ...
                            if (result.value == true) {
                              ...
                              location.href ="/catalogos/servicios_a";
                              $('.botoncito').show();
                            }
                        })
