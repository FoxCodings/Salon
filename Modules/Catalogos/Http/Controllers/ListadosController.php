...
use \Modules\Catalogos\Entities\Faltantes;
...

{
    ...
    {
        return view('catalogos::listados.index');
    }
    ...
    public function TraerProductos(Request $request){
      $faltantes = Faltantes::where([['activo',1],['modulo',1]])->get();
      return $faltantes;
    }
    ...
    $data['productos'] =  Faltantes::where([['activo',1],['modulo',1]])->get();

    //dd($data);
    /////////////////////////////////////////////////////////////////////////
    //dd($data['proveedor']);
    $pdf = PDF::loadView('catalogos::listados.productosfaltantes', $data);
    ...
    {
        return view('catalogos::listados.create');
    }
    ...
    {
        return view('catalogos::listados.show');
    }
    ...
    {
        return view('catalogos::listados.edit');
    }
