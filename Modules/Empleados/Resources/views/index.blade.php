...
<div class="card-toolbar">
  ...
  <a href="/empleados/createImagen" class="btn btn-primary font-weight-bolder font-size-sm mr-3">
...
<a href="/empleados/create" class="btn btn-primary font-weight-bolder font-size-sm ">
  <span class="svg-icon svg-icon-md"><!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"></rect>
        <circle fill="#000000" cx="9" cy="15" r="6"></circle>
  ...
  var today = new Date();
    ...
    function Listavacaciones(id){
      ...
      $.ajax({
         ...
         url:"/empleados/ListAVacaciiones",
         headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
         },
         data:{
      ...
      Swal.fire({
            ...
            if (result.value) {
              ...
              $.ajax({
                 ...
                 url:"/empleados/Crearusuariocajero",
                 headers: {
                  'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                 },
                 data:{
