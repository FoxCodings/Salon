...
use \Modules\Empleados2\Entities\Descanso;
...
class Empleados2Controller extends Controller
{
  public function __construct()
  {
    ...
    {
        return view('empleados2::create');
    }

    public function createImagen()
    {
        return view('empleados2::crearImagen');
    }
    ...
    public function edit($id)
    {
        ...
        return view('empleados2::create')->with($data);
    }
    ...
    public function tablaempleados2(){
      setlocale(LC_TIME, 'es_ES');
      \DB::statement("SET lc_time_names = 'es_ES'");
      $registros = Empleados::where([['activo', 1],['modulo',2],['id','!=',1]])->get(); //user es una entidad que se trae desde la app
        ...
        //   }else{
            ...
            if ($value->dias_vacaciones == '' || $value->dias_vacaciones == 0) {
              $acciones = [
                "Editar" => [
                  "icon" => "edit blue",
                  "href" => "/empleados2/$value->id/edit" //esta ruta esta en el archivo web
                ],
                "Credencial" => [
                  "icon" => "edit blue",
                  "href" => "/empleados2/documento/$value->id"
                ],
                // "Asignar Mostrador" => [
                //   "icon" => "edit blue",
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $pdf = PDF::loadView('empleados2::impresion2', $data);
