...
<div class="card-footer">
  ...
  <a href="/empleados2" class="btn btn-default">Regresar</a>
...
semana_4 == '') {
      ...
      $.ajax({
             ...
             url:"{{ ( isset($empleados) ) ? '/empleados2/update': '/empleados2/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
             headers: {
