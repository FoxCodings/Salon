...
<div class="card-footer">
  ...
  <a href="/clientes2" class="btn btn-default">Regresar</a>
        ...
        form.addEventListener('click', function (event) {
          if (!form.checkValidity()) {
            ...
            $.ajax({
                   ...
                   url:"{{ ( isset($clientes) ) ? '/clientes2/update': '/clientes2/create' }}", //si existe colores manda la ruta de anillos el id del usario sino va mandar anillos crear
                   headers: {
