                    ...
                    <div class="card-body" >
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-lg-6">
                                <label>Equipo:</label>
                                <input
                                type="text" name="name" class="form-control" id="equipo" disabled>
                              </div>
                              <div class="col-lg-6">
                                <label>Número de Serie :</label>
                                <input  type="text" name="text" class="form-control" id="serie" disabled>
                              ...
                              <div class="col-lg-6">
                                ...
                                type="text" name="name" class="form-control" id="asignado_a"  disabled>
                              </div>
                              <div class="col-lg-6">
                                <label>Fip:</label>
                   ...
                   data:{
                    ...
                    success:function(data){
                      ...
                      for (var i = 0; i < data.length; i++) {
                        ...
                        var equipo_nombre = data[i].nom_equ;
                        var equipo_serie = data[i].serie;

                        var fecha  = data[i].fec;
                        var fip  = data[i].nom;

                        var asignado = nombre+' '+apellido_p+' '+apellido_m;


                          $('#equipo').val(equipo_nombre);
