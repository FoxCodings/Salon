...
<html lang="en" >
    ...
    <!-- <body  id="kt_body"   class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading"  style="background-image: url('/cremita/img/fondo.png');background-repeat: no-repeat;background-size: 1950px 950px;"  > -->
      <body  id="kt_body"  class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize aside-minimize-hoverable page-loading" style="background-image: url('/cremita/img/fondo.png');background-repeat: no-repeat;background-size: 1950px 950px;" >
  ...
  <div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed " >
	...
	<a href="/dashboard_dos">
		<img alt="Logo" src="/cremita/img/VIT & LIVE.png" width="100"/>
	</a>
	<!--end::Logo-->
            ...
            <div id="kt_header" class="header  header-fixed " style="background:#ec5a93;">
            	...
            	<div class=" container-fluid  d-flex align-items-stretch justify-content-between" >
                  ...
                  <div class="header-logo">
                    ...
                    <a href="/dashboard_dos">
        							<img alt="Logo" src="/cremita/img/VIT & LIVE.png" width="120" height=""/>
        						</a>
                    @else
                    <a href="/ventas">
        							<img alt="Logo" src="/cremita/img/VIT & LIVE.png" width="120" height=""/>
