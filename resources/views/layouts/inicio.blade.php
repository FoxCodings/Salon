...
<html lang="en" >
    ...
    <body  id="kt_body"  class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading" style="background-image: url('/cremita/img/fondo.png');background-repeat: no-repeat;background-size: cover;"  >
...
<!--end::Aside-->
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper" >
    				<!--begin::Header-->
            <div id="kt_header" class="header  header-fixed " style="background:#ffbdd7;">
            	<!--begin::Container-->
                ...
                border-color: #ffbdd7;">
                  ...
                  <!-- <div class="dropdown">
                            ...
                            <ul class="navi navi-hover py-4" id="lista_mensajes">
                                 @if(mensajes() == '[]')
                                   <li class="navi-item" >
                                       <a   class="navi-link">
                                           <i class="far fa-bell text-danger mr-5"></i>
                                           <span class="navi-text">Sin Mensajes</span>
                                       </a>
                                 ...
                                 @else
                                    @foreach (mensajes() as $key => $mensaje)
                                     ...
                                     <li class="navi-item" >
                                         <a  onclick="verMensaje({{ $mensaje->id }})" class="navi-link">
                                             <i class="far fa-bell text-info mr-5"></i>
                                             <span class="navi-text">{{ substr($mensaje->mensaje,-12); }}</span>
                                         </a>
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="50px,0px" aria-expanded="false">
                      <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"  style="color: #000;
                          background-color: #ffbdd7;
                          border-color: #ffbdd7;">
                          <img src="/cremita/img/icono.png" alt="">
            		         <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1"><span style="color:#EC5A93;">Hola,</span>  </span>
                          <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><span style="color:#EC5A93;">{{ Auth::user()->nombre }} {{ Auth::user()->apellido_paterno }} {{ Auth::user()->apellido_materno }}</span></span>
                          <span class="symbol symbol-lg-35 symbol-25 symbol-light-primary">
                              <span class="symbol-label font-size-h5 font-weight-bold"><i class="far fa-id-badge" style="color: white !important; "></i></span>
                          </span>
                      </div>
                  </div>
                  <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right" style="">
                      ...
                      <ul class="navi navi-hover py-4">
                          ...
                          @endif
                          <a onclick="actualizar()" class="navi-link"  class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5"><span class="navi-text" style="font-size:7.5pt;"><i class="fas fa-sync"></i> Actualizar Permisos</span></a>
                             ...
                             @csrf
                              ...
                              <!-- <a href="#" class="navi-link">
                                  <span class="symbol symbol-20 mr-3">
                                      <img src="/admin//admin/assets/media/svg/flags/226-united-states.svg" alt="">
                                  </span>
...
<div class="modal fade" id="mensajitobb" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                  ...
                  <div id="idmensajever"></div>

                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal" onclick="eliminarMensaje()">Cerrar</button>
