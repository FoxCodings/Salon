...
<p style="max-width: 1120px; display: block; width: 560px;font-family: 'Sriracha', cursive;font-size: 48px; color: #ffffff; line-height: 125%;"><?php list($confi) = configuracion(); print_r($confi->nombre_empresa);?></p>
</td>
...
</h2>Ubicación: <?php list($confi) = configuracion(); print_r($confi->direccion);?>,<?php list($confi) = configuracion(); print_r($confi->cp);?>
<br>
Correo Electronico: <?php list($confi) = configuracion(); print_r($confi->correo_electronico);?>, Telefono: <?php list($confi) = configuracion(); print_r($confi->telefono);?>
<br>
...
Copyright &copy; <?php list($confi) = configuracion(); print_r($confi->nombre_empresa);?> <?php echo date('Y'); ?>
</div>
</td></tr></tbody>
</div>  </td> </tr> </tbody>
