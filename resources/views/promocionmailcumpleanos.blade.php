...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; border: 1px solid #cccccc;">
	...
	<tr>
		<?php $e_message; ?>
		<td  style="padding: 40px 0px 0px 0px;color: #000;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
				<tr>
					<td style="background-image:url('https://goldsystemvit.hbproyectos.com/cremita/img/body.png'); background-size:600px 550px; background-repeat:no-repeat; font-family: Arial, sans-serif; font-size: 16px; ">
            ...
            <span style="font-size: 12px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif;text-align: center; line-height: 150%;">
            ...
            <span style="font-size: 9px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif;text-align: center;  line-height: 26px;">
